...
gulp.task("scss:build", function () {
  return gulp
    .src(path.src.scss)
    .pipe(customPlumber("Error Running scss:build"))
    .pipe(process.env.NODE_ENV === 'development' ? sourcemaps.init() : gutil.noop())
    .pipe(
      sass({
    ...
    .pipe(autoprefixer())
    .pipe(process.env.NODE_ENV === 'production' ? cleanCSS() : gutil.noop())
